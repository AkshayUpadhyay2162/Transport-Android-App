...
public class Shopkeeper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "This is shopkeeper fragment...", Snackbar.LENGTH_LONG).setAction("Action", null).show();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.shopkeeper, menu);
        return true;
    }
    ...
    public void Home(MenuItem item) {
        Intent intent = new Intent(Shopkeeper.this,MainActivity.class);
